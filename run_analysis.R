...
setwd("C:\\Users\\Audra\\Documents\\R-Research\\Data Cleansing\\Course Project\\UCI HAR Dataset")
...
#using activity1 as this will be dropped later.
...
#2cExtracts only the measurements on the mean and standard deviation for each measurement. 
